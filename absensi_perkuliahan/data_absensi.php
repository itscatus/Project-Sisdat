...
<body>
    ...
    <div class="section">
        <div class="container2">
            ...
            <div class="box">
                <p>
                <div class="btn3"><a href="update_absensi.php">Tambah Data</a></div>
                </p>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td width="120px"><a href="edit_absensi.php?id=<?php echo $row['id_absensi'] ?>">
                                            <div class="btn">Edit</div><a href="delete_absensi.php?del_id=<?php echo $row['id_absensi'] ?>" onclick="return confirm('Data yang telah dihapus tidak dapat dikembalikan. Yakin ingin menghapus?')">
