...
<body>
    ...
    <div class="section">
        <div class="container2">
            ...
            <div class="box">
                <p><div class="btn3"><a href="update_matkul.php">Tambah Data</a></div></p>
                <table border="1" cellspacing="0" class="table">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $matkul = mysqli_query($koneksi, "SELECT * from perkuliahan join dosen where perkuliahan.nip_dosen = dosen.nip_dosen order by kode_matkul");
                        ...
                        ?>
                            <tr>
                                ...
                                <td width="120px"><a href="edit_matkul.php?id=<?php echo $row['kode_matkul'] ?>">
                                            <div class="btn">Edit</div><a href="delete_matkul.php?del_id=<?php echo $row['kode_matkul'] ?>" onclick="return confirm('Data yang telah dihapus tidak dapat dikembalikan. Yakin ingin menghapus?')">
